<div class="full-box page-header">
			...
			<div class="container-fluid">
			    <ul class="full-box list-unstyled page-nav-tabs">
			        ...
			        <li>
			            <a class="<?php echo SERVERURL ?>active" href="reservation-search/"><i class="fas fa-search-dollar fa-fw"></i> &nbsp; BUSCAR POR FECHA</a>
			        </li>
			    </ul>
			</div>
						...
						<div class="row justify-content-md-center">
							...
							<div class="col-12 col-md-4">
								<div class="form-group">
									...
									<input type="date"
									 class="form-control" 
									 name="busqueda_final_prestamo" id="fecha_final" maxlength="30">
								</div>
							</div>
							<div class="col-12">
