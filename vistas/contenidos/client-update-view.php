...
<div class="full-box page-header">
			...
			<div class="container-fluid">
				...
				$datos_cliente=$ins_cliente->datos_cliente_controlador("Unico",
			$pagina[1]);
							...
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[0-9-]{1,27}"
										 class="form-control" name="cliente_dni_up" value="<?php 
										 echo $campos['cliente_dni']; ?>"
									...
									<div class="form-group">
										...
										<input type="text"
										 pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}"
										  class="form-control" name="cliente_nombre_up" value="<?php 
										 echo $campos['cliente_nombre']; ?>"
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}"
										 class="form-control" name="cliente_apellido_up"value="<?php 
										 echo $campos['cliente_apellido']; ?>"
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[0-9()+]{8,20}"
										 class="form-control" name="cliente_telefono_up"value="<?php 
										 echo $campos['cliente_telefono']; ?>" id="cliente_telefono" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,150}" class="form-control"
										 name="cliente_direccion_up"value="<?php 
										 echo $campos['cliente_direccion']; ?>" id="cliente_direccion" maxlength="150">
									</div>
								</div>
							</div>
						</div>
