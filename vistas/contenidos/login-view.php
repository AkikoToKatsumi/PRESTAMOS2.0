    ...
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo" style="margin: 0px 0px 0 -50px;">
                <a href="<?php echo SERVERURL; ?>index.php"><img src="<?php echo SERVERURL; ?>assets/compiled/svg/logoaki2.png" alt="Logo"></a>
            </div>
            <h1 class="auth-title">Log in.</h1>
            <p class="auth-subtitle mb-5">Introduce tus datos para iniciar sesion</p>
