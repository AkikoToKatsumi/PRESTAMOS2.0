...
//vid 64 
    ...
    protected static function actualizar_empresa_modelo($datos){
     $sql=mainModel::conectar()->prepare("UPDATE empresa SET 
     empresa_nombre=:Nombre,empresa_email=:Email,empresa_telefono=:Telefono,empresa_direccion=:Direccion WHERE empresa_id=:ID");
